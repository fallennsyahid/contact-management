      ...
      <div className="bg-gray-800 bg-opacity-80 p-8 rounded-xl shadow-xl border border-gray-700 backdrop-blur-sm w-full max-w-md">
        ...
        <form>
          ...
          <div className="mb-6">
            <button
              type="submit"
              className="w-full bg-gradient text-white py-3 px-4 hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-800 transition-all duration-200 font-medium shadow-lg transform hover:-translate-y-0.5"
            >
          ...
          <div className="text-center text-sm text-gray-500 space-x-2">
            ...
            <Link className="text-blue-400 hover:text-blue-300 font-medium transition-colors duration-200">
              Sign Up
            </Link>
          </div>
        </form>
