...
const AddAddressCard = () => {
  return (
    <div className="bg-gray-700 p-5 rounded-lg border-2 border-dashed border-gray-600 shadow-md transition-all duration-300 ease-in-out hover:-translate-y-1 hover:shadow-lg">
